...
public class Journey_Details extends JFrame{  //Forth
    ...
    public Journey_Details(){
        ...
        setTitle("JOURNEY_DETAILS");//super("") can also be used here
	...
	JComboBox comboBox = new JComboBox(items1);//creates a 1d and add them in combo box
	comboBox.setBounds(150, 100, 150, 27);
	add(comboBox);
		
		
	String[] items2 =  {"BANGALORE", "MUMBAI", "CHENNAI", "PATNA","DELHI","HYDERABAD"};
	JComboBox comboBox_1 = new JComboBox(items2);//combo box used for to click and open a list have to put all values in a list
	...
	Show.addActionListener(new ActionListener(){
		...
		try{
                    String src  = (String) comboBox.getSelectedItem();// to get a selected item i.e banglore to mumbai we use this function
                    String dst  = (String) comboBox_1.getSelectedItem();//selectedItem returns object data bt we want in string format so we type cast it
