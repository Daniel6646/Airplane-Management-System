...
public class Add_Customer extends JFrame{ //Third Frame
	...
	JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;
        ...
        public Add_Customer(){
            getContentPane().setForeground(Color.BLUE);//for font
            ...
            Next.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    ...
                    String gender = null;//empty string so we can add value to it below for gender
                    ...
                    if(NewRadioButton.isSelected()){
                        ...
                        gender = "female"; //else if means only one will be selected here
                    }
                    ...
                    try {
                        ...
                        c.s.executeUpdate(str);//check diff btween executeUpdate and executeQuery
